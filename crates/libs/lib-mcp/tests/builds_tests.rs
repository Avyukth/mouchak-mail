...
use lib_mcp::tools::builds;
use lib_mcp::tools::{AcquireBuildSlotParams, ReleaseBuildSlotParams, RenewBuildSlotParams};
use libsql::Builder;
use std::sync::Arc;
...
async fn test_renew_build_slot_impl_success() {
    ...
    use lib_core::model::build_slot::BuildSlotForCreate;
