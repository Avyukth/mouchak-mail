...
impl GuardMode {
    ...
    ///
    /// ```
    /// # use mouchak_mail_core::model::precommit_guard::GuardMode;
...
impl PrecommitGuardBmc {
    ...
    /// # use mouchak_mail_core::model::precommit_guard::PrecommitGuardBmc;
                ...
                rt.block_on(async {
                    ...
                    let dummy_mm = {
                        ...
                        ModelManager::new_for_test(
                            conn,
                            temp_dir.path().to_path_buf(),
                            std::sync::Arc::new(mouchak_mail_common::config::AppConfig::default()),
                        )
                    };
