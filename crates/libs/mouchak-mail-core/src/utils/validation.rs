...
///
/// ```
/// use mouchak_mail_core::utils::validation::{ValidationError, validate_agent_name};
///
...
///
/// ```
/// use mouchak_mail_core::utils::validation::validate_project_key;
///
...
///
/// ```
/// use mouchak_mail_core::utils::validation::validate_reservation_path;
///
...
///
/// ```
/// use mouchak_mail_core::utils::validation::validate_ttl;
///
/// assert!(validate_ttl(3600).is_ok());     // 1 hour - valid
